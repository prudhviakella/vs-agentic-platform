...
class TestAPIKeyAuth:
    ...
    def test_valid_api_key_returns_auth_context(self):
        import hmac, hashlib
        from vs_platform.gateway.auth import _validate_api_key
...
class TestRateLimiter:
    ...
    def test_within_limit_allows_request(self):
        from vs_platform.gateway.rate_limiter import _store, RateLimit
    ...
    def test_exceeds_limit_blocks_request(self):
        from vs_platform.gateway.rate_limiter import _store
